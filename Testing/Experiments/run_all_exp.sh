...
python chaser_evader_experiments.py --rl A2C --steps 1000000 --name A2C_chaser_rstart_rgoal_1msteps --random_goals --random_start
...
python chaser_evader_experiments.py --rl A2C --steps 1000000 --name A2C_chaser_rstart_rgoal_1msteps --random_goals --random_start --rl_evader
