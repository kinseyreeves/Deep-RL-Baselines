...
/usr/bin/timeout 1800s python maze_experiments.py --rl PPO --name PPO_vs_DQN_final --random_goals --random_start --1reward --num_goals 3 --map_size 5
/usr/bin/timeout 1800s python maze_experiments.py --rl DQN --name PPO_vs_DQN_final --random_goals --random_start --num_goals 3 --map_size 5
