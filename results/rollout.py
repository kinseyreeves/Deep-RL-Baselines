...
#         self.env = gym.make("n-maze-v0", config = env_config)
...
# #config={"env_config": {"extra_joints": 1, "extra_state": False}}
# #register_env("n-joints-v0", lambda _: config, NJointArm(config = {"extra_joints": 1, "extra_state": False}))
#
# direc = "/home/krer/Documents/Dev/2019/MastersProject/Testing/Experiments/maps/"
# config = {"mapfile": dir + "map_3x3.txt","full_state": False, "normalize_state": True,"randomize_start":False, "randomize_goal": True}
# arm_config = {"extra_joints": 1, "full_state": False, "normalize_state": True}
#
# #env = env_creator('maze')
# #register_env('mazeEnv', lambda config: MazeEnv2)
# register_env('reacher', lambda arm_config: NJointArm)

#
# def env_creator(config):
#     return SimpleCorridor(config)
# config = {"corridor_length":2}
#
# ray.tune.register_env('myEnv', lambda config:SimpleCorridor(config))
#Map directory
direc = "/home/krer/Documents/Dev/2019/MastersProject/Testing/Experiments/maps/"
...
config_evader5 = {"mapfile": map_loader.get_5x5_map(),"RL_evader": True, "slowdown_step": True, "full_state": False, "normalize_state": True,"randomize_start":True, "randomize_goals": True}
